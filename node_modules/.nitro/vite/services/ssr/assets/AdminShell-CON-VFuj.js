import { o as Button, s as cn } from "./format-Dd0mwkMk.js";
import { d as Skeleton } from "./Primitives-CaxSyH9b.js";
import { d as TooltipProvider, f as TooltipTrigger, l as Tooltip, m as useIsMobile, o as TENANT_ID, p as Input, u as TooltipContent } from "./client-CjaA9JUL.js";
import * as React from "react";
import { Link, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Activity, AlertTriangle, FileText, Gauge, Headset, MessageSquare, MessagesSquare, PanelLeft, Settings, ShieldAlert, UploadCloud, UserCog, X } from "lucide-react";
...
function AdminSidebar() {
	...
	return /* @__PURE__ */ jsxs(Sidebar, {
		...
		children: [
			...
			/* @__PURE__ */ jsx(SidebarContent, { children: GROUPS.map((group, i) => /* @__PURE__ */ jsxs(SidebarGroup, { children: [group.label && /* @__PURE__ */ jsx(SidebarGroupLabel, { children: group.label }), /* @__PURE__ */ jsx(SidebarMenu, { children: group.items.map(({ to, label, icon: Icon }) => {
			...
			/* @__PURE__ */ jsxs(SidebarFooter, {
				...
				}), /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(SidebarMenuButton, {
					tooltip: "Admin profile",
					className: "cursor-default",
					children: [/* @__PURE__ */ jsx(UserCog, {}), /* @__PURE__ */ jsx("span", { children: "Admin profile" })]
				}) }) })]
			})
		]
	});
...
function AdminShell({ children }) {
	return /* @__PURE__ */ jsxs(SidebarProvider, { children: [/* @__PURE__ */ jsx(AdminSidebar, {}), /* @__PURE__ */ jsxs(SidebarInset, {
		className: "min-w-0",
		children: [/* @__PURE__ */ jsxs("header", {
			className: "sticky top-0 z-10 flex h-14 shrink-0 items-center gap-2 border-b border-border bg-card px-3",
			children: [
				/* @__PURE__ */ jsx(SidebarTrigger, { "aria-label": "Toggle navigation" }),
