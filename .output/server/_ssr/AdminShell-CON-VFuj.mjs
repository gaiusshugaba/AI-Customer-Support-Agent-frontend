...
import { C as Headset, E as FileText, H as Activity, _ as MessageSquare, h as PanelLeft, i as TriangleAlert, j as CloudUpload, l as ShieldAlert, r as UserCog, t as X, u as Settings, v as MessagesSquare, w as Gauge } from "../_libs/lucide-react.mjs";
import { l as Skeleton } from "./Primitives-CaxSyH9b.mjs";
import { a as DialogOverlay, i as DialogDescription, n as DialogClose, o as DialogPortal, r as DialogContent, s as DialogTitle, t as Dialog } from "../_libs/@radix-ui/react-dialog+[...].mjs";
import { a as TENANT_ID, c as TooltipProvider, i as Input, l as TooltipTrigger, o as Tooltip, p as useIsMobile, s as TooltipContent } from "./client-CjaA9JUL.mjs";
import { t as Root } from "../_libs/radix-ui__react-separator.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AdminShell-CON-VFuj.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-sidebar-primary text-sidebar-primary-foreground",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							className: "text-[11px] uppercase tracking-wide text-sidebar-foreground/60",
							children: "AI Support Ops"
						})]
					})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarContent, { children: GROUPS.map((group, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [group.label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: group.label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: group.items.map(({ to, label, icon: Icon }) => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-mono text-[11px] text-sidebar-foreground/60",
							children: TENANT_ID
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarMenuButton, {
					tooltip: "Admin profile",
					className: "cursor-default",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserCog, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Admin profile" })]
				}) }) })]
			})
		]
	});
...
function AdminShell({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarInset, {
		className: "min-w-0",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "sticky top-0 z-10 flex h-14 shrink-0 items-center gap-2 border-b border-border bg-card px-3",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, { "aria-label": "Toggle navigation" }),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "FlowStack AI Support Ops"
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
